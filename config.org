...
Symbol highlighting and possibility for jumping between symbols
Enabled by default in python buffers.
...
#+BEGIN_SRC emacs-lisp
  ...
  ;;                                                          "/home/roenne/.env/ALL/bin/pylsp"
  ;;                                                          "/Users/au566369/.envs/dev/bin/pylsp"))))
...
#+BEGIN_SRC emacs-lisp
  ...
  ;;   (setq tramp-default-method "rcp") ;; scp
